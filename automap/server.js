...
app.post('/generate-mindmap', async (req, res) => {
  ...
  * Each edge has id, source, and target.
  ...
  {
    nodes: [
      { id: '1', type: 'mindMapNode', position: { x: 250, y: 5 }, data: { label: 'NODE A' } },
      { id: '2', type: 'mindMapNode', position: { x: 450, y: 100 }, data: { label: 'NODE B' } },
      { id: '3', type: 'mindMapNode', position: { x: 650, y: 200 }, data: { label: 'NODE C' } }
    ],
    edges: [
